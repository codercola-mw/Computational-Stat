...
```
 ...
 Compare the value obtained from the above step 1 and step 2, it can be seen that the real value only close to the value that is estimated from the chi-sqaure as proposal distribution, which is 5.950549. 
...
```{r echo=F}
data <- load("~/Computational Stat/732A90_VT2020_Materials/chemical.RData")
