...
```
 ...
 According to the above plot showing the relationship between Y and i, indicating the result returned from `myvar` function and `var` function are different. ++++++++++++++++++++++++++ can you explain the behavior?
 
## 3-4.

 Better code that returns the same result as var
