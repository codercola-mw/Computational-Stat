...
selections[]
   ...
   ## Several of them has a population that exceeds 200,000
...
$$(\frac{f_{X}(y)}{f_{Y}(y)})'=(\frac{2}{\sqrt{2\pi}} e^{x-\frac{1}{2}x^2})'=\frac{2}{\sqrt{2\pi}} e^{x-\frac{1}{2}x^2}(-x+1) = 0 \\ \Rightarrow  (-x+1) = 0 \Rightarrow x=1$$
 ...
 Now put this x into the ratio and it is possible to get that $c=\frac{f_{X}(1)}{f_{Y}(1)}=$ $\frac{2}{\sqrt{2\pi}} e^{1-\frac{1}{2}}=$ $\frac{2}{\sqrt{2\pi}} e^{\frac{1}{2}} = 1.31$ (rounded in two decimals) which is the optimal value of c.
